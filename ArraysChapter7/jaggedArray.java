/**Write a piece of code that constructs a 
jagged two-dimensional array of integers named jagged 
...
left-to-right order (also called row-major order). In other words, the array's contents should be the following:
